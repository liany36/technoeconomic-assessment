...
export function TransmissionCost(input: InputModTransimission) {
  ...
  switch (input.VoltageClass) {
    ...
    case '345 kV Single Circuit': // -----------------------------------------------
      ...
      ROWwidth = 175;
      break;
    case '345 kV Double Circuit': // -----------------------------------------------
      InitialCost = 2077000;
      InitialCost = InitialCost * (1 + InflationRate);
      switch (input.ConductorType) {
        case 'ACSR':
          Multiplier.Conductor = 1;
          LineLossUnitMile = 0.3212;
          break;
        case 'ACSS':
          Multiplier.Conductor = 1.08;
          LineLossUnitMile = 0.8018;
          break;
        case 'HTLS':
          Multiplier.Conductor = 3.6;
          LineLossUnitMile = 0.7918;
          break;
      }
      switch (input.Structure) {
        case 'Lattice':
      ...
      ROWwidth = 200;
      break;
    case '500 kV Single Circuit': // -----------------------------------------------
      InitialCost = 1854000;
      InitialCost = InitialCost * (1 + InflationRate);
      switch (input.ConductorType) {
        case 'ACSR':
          Multiplier.Conductor = 1;
          LineLossUnitMile = 0.1079;
          break;
        case 'ACSS':
          Multiplier.Conductor = 1.08;
          LineLossUnitMile = 0.284;
          break;
        case 'HTLS':
          Multiplier.Conductor = 3.6;
          LineLossUnitMile = 0.2968;
          break;
      }
      switch (input.Structure) {
        case 'Lattice':
      ...
      ROWwidth = 200;
      break;
    case '500 kV Double Circuit': // -----------------------------------------------
      InitialCost = 2967000;
      InitialCost = InitialCost * (1 + InflationRate);
      switch (input.ConductorType) {
        case 'ACSR':
          Multiplier.Conductor = 1;
          LineLossUnitMile = 0.2159;
          break;
        case 'ACSS':
          Multiplier.Conductor = 1.08;
          LineLossUnitMile = 0.568;
          break;
        case 'HTLS':
          Multiplier.Conductor = 3.6;
          LineLossUnitMile = 0.5936;
          break;
      }
      switch (input.Structure) {
        case 'Lattice':
      ...
      switch (input.NewOrReconductor) {
        case 'New':
          ...
          break;
        case 'Re-conductor':
          Multiplier.NewOrReconductor = 0.65;
          break;
      }
      ROWwidth = 250;
      break;
    case '500 kV HVDC Circuit': // -----------------------------------------------
      ...
      ROWwidth = 200;
      break;
    case '600 kV HVDC Circuit': // -----------------------------------------------
      InitialCost = 1558200;
      InitialCost = InitialCost * (1 + InflationRate);
      switch (input.ConductorType) {
        case 'ACSR':
          Multiplier.Conductor = 1;
          LineLossUnitMile = 0.1147;
          break;
        case 'ACSS':
          Multiplier.Conductor = 1.08;
          LineLossUnitMile = 0.3076;
          break;
        case 'HTLS':
          Multiplier.Conductor = 3.6;
          LineLossUnitMile = 0.2986;
          break;
      }
      switch (input.Structure) {
        case 'Lattice':
